...
timeout 30s grep -q 'Press Ctrl-C to terminate...' <(tail -f $logDir/sil-kit-registry_${timestamp}_chardev.out) || (echo "[error] Timeout reached while waiting for sil-kit-registry to start"; exit 1;)
