...
public:
    constexpr auto GetName() const noexcept -> const char *
    {
        return _info.name;
    }
    constexpr auto GetLabel() const noexcept -> const char *
    {
        return _info.label;
    }
    constexpr auto GetLines() const noexcept -> offset_t
    {
        return _info.lines;
    }
...
private:
    gpiochip_info _info;
    constexpr ChipInfo(gpiochip_info info) noexcept
        : _info(info)
    {
    }
};
...
public:
    constexpr auto GetOffset() const noexcept -> bool
    {
        return _info.line_offset;
    }
    constexpr auto GetDirection() const noexcept -> Dir
    {
        return _info.flags & GPIOLINE_FLAG_IS_OUT ? Out : In;
    }

private:
    gpioline_info _info;
    constexpr LineInfo(gpioline_info info) noexcept
        : _info(info)
    {
    }
};
